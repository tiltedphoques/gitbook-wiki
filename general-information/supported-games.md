...
{% hint style="warning" %}
We **only** support Skyrim Special Edition **1.6.XXX** and above. You do not need to buy the Anniversary Upgrade. We recommend playing without it for the best experience.
{% endhint %}

### Supported versions

{% hint style="success" %}
* The Elder Scrolls V: Skyrim Special Edition (Steam  | V 1.6.XX)
{% endhint %}
